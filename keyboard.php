<?php
    $pageTitle = "Produk Keyboard - GADGET GLAM";
?>
<!DOCTYPE html>
<html lang="en">
    <head>
    ...
    <body>
        ...
        <main>
            <section class="header">
                <img src="./img/cat-keyboard.jpg" alt="Banner Keyboard" class="header__bg" />
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <div class="header__content">
                                <span class="header__subtitle">KATEGORI</span>
                                <h1>Produk <em>Keyboard</em></h1>
                                <p>Tingkatkan kenyamanan mengetik menggunakan <em>keyboard</em> berkualitas</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="product__list">
                                <div class="row" id="keyboard-list"></div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <script src="js/renderKeyboard.js" type="module"></script>
