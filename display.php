<?php
    $pageTitle = "Produk Display - GADGET GLAM";
?>
<!DOCTYPE html>
<html lang="en">
    <head>
    ...
    <body>
        ...
        <main>
            <section class="header">
                <img src="./img/cat-display.avif" alt="Banner Display" class="header__bg" />
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <div class="header__content">
                                <span class="header__subtitle">KATEGORI</span>
                                <h1>Produk <em>Display</em></h1>
                                <p>Utamakan kenyamanan mata dengan menggunakan <em>display</em> berkualitas</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="product__list">
                                <div class="row" id="display-list"></div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <script src="js/renderDisplay.js" type="module"></script>
