<?php
$pageTitle = "Produk Storage - GADGET GLAM";
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    ...
    <main>
        <section class="header">
            <img src="./img/cat-storage.jpg" alt="Banner Storage" class="header__bg" />
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <div class="header__content">
                            <span class="header__subtitle">KATEGORI</span>
                            <h1>Produk <em>Storage</em></h1>
                            <p>Pastikan data mu aman dengan menggunakan <em>storage</em> berkualitas</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="product__list">
                            <div class="row" id="storage-list"></div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script src="js/renderStorage.js" type="module"></script>
